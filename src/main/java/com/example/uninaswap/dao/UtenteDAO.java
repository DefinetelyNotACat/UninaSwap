...
=======
            ...
            try (ResultSet rs = query.executeQuery()) {
                if (rs.next()) {
                    ...
                    utente.setPathImmagineProfilo(rs.getString("immagine_profilo"));
                    // utente.setId(rs.getInt("id")); // NOTE: This was commented out in your version, kept as is.
                }
>>>>>>> Stashed changes
            }
        }
...
=======
    ...
    // This method uses YOUR logic to throw specific exceptions (Matricola, Email, Username)
    public void verificaEsistenzaUtenteRegistrazione(String username, String email, String matricola) throws Exception {
        ...
        try (Connection connessione = PostgreSQLConnection.getConnection();
            ...
            try (ResultSet rs = query.executeQuery()) {
                if (rs.next()) {
                    String nomeutente = rs.getString("username"); // Changed index to column name for safety, but index works too
