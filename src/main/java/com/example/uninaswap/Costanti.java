...
public class Costanti {
    ...
    public static final String pathReportOfferte = "/com/example/uninaswap/reportOfferte.fxml";
    public static final String pathNessunaOfferta = "/com/example/uninaswap/nessunaOfferta.fxml";
}
